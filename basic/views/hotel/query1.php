...
<div>
  ...
  <h5>Получить перечень и общее число фирм, забронировавших места в объеме, не менее указанного, за весь период сотрудничества, либо за некоторый период. </h5>
  <div class="row">
    <div class="col-12 col-md-8">
      <?php $form = ActiveForm::begin(['id' => 'filter-form']); ?>

      <?= $form->field($model, 'countOfPeople')->textInput()->label('Количество мест')?>
      ...
      <div class="form-group">
        ...
        <?= Html::a('Обновить форму', ['hotel/query1'], ['class' => 'btn btn-warning']) ?>
